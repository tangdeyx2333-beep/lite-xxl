...
style.scrollbar_interaction_margin = common.round(28 * SCALE)
...
style.font = renderer.font.load(DATADIR .. "/fonts/AlibabaPuHuiTi-3-85-Bold.ttf", 15 * SCALE, {antialiasing="grayscale", hinting="full"})
...
style.code_font = renderer.font.load(DATADIR .. "/fonts/AlibabaPuHuiTi-3-85-Bold.ttf", 15 * SCALE, {antialiasing="grayscale", hinting="full"})
